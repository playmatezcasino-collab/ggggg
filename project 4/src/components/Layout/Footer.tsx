...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-playmatez-green text-playmatez-white apply-pulse-glow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/how-to-invest" className="text-playmatez-white/80 hover:text-playmatez-gold transition-colors">
                  {t('navigation.howToInvest')}
                </Link>
              </li>
              <li>
